package com.tzj.controller.aop;

import com.tzj.controller.exception.ControllerException;
...
public class Advice {
     ...
     * @throws Throwable
     */
    @Around("execution(* com.tzj.controller.*Controller.*(..))")
    ...
    public Object handleException(HttpServletRequest httpServletRequest, Throwable throwable) {
        ...
        if (throwable instanceof IllegalArgumentException) {
            ...
            return ResultVo.ofError(((ControllerException) throwable).getMsg());
